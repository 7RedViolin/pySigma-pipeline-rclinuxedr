...
from sigma.pipelines.rclinuxedr import # TODO: add pipeline imports or delete this line
import sigma
import re
from typing import ClassVar, Dict, Tuple, Pattern, List, Any, Optional

class rclinuxedrBackend(TextQueryBackend):
    """rclinuxedr backend."""
    ...
    name : ClassVar[str] = "rclinuxedr backend"
