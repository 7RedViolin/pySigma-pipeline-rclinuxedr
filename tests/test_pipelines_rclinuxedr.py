    ...
    assert test_backend.convert(
        SigmaCollection.from_yaml("""
            ...
            detection:
                ...
                condition: sel
        """)
    ) == ['event_type_cd="process_start" and process_pid="process_pid_here" and process_name="process_path_here" and process_path="process_path_here" and process_command_line="process_command_line_here" and working_directory="working_directory_here" and (user_name="user_name_and_login_user_name_here" or login_user_name="user_name_and_login_user_name_here") and process_md5="process_md5_here" and process_sha256="sha256_here" and parent_process_pid="parent_process_pid_here" and parent_process_name="parent_process_path_here" and parent_process_path="parent_process_path_here"']
