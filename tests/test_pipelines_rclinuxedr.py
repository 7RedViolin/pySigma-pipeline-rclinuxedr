...
def test_rclinuxedr_network_no_direction_mapping(cortexxdr_backend : CortexXDRBackend):
...
def test_rclinuxedr_network_outbound_mapping(cortexxdr_backend : CortexXDRBackend):
    assert cortexxdr_backend.convert(
        SigmaCollection.from_yaml("""
            title: Test
            status: test
